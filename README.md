ДЗ 36. Створення товарів


Вам потрібно реалізувати 3 сторінки
1. Сторінка - форма з для створення товару (Назва, опис, ціна)
2. Сторінка - Таблиця створених товарів (id, назва, ціна, кнопка видалення, кнопка редагування)
3. Сторінка редагування товару - така сама як і створення, тільки при збереженні повинно відбуватись редагуваня створеного товару, а НЕ створення
...
1) Масив обєктів товарів
2) Поле selectedProductID - де буде зберігатись id вибраного товару для сторінки edit товару.
